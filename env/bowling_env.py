...
class BowlingEnv(MujocoEnv, utils.EzPickle):
    r"""
    ## Description
    ...
    * v0: Initial versions release.
    ...
    def _get_rew(self, action):
        ...
        reward_speed = speed * 0.2

        reward = reward_ctrl + reward_dist + reward_speed
    ...
    def reset_model(self):
        ...
        while True:
            ...
            if np.linalg.norm(self.object_pos - self.goal_pos) > 0.17:
                break

        qpos[-4:-2] = self.object_pos
